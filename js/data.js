...
function palaMediaFolderUrl(p) {
  ...
  if (!cat) return null;
  // Por ID y no por nombre: en Drive renumeran las subcarpetas al sumar una.
  const folderId = (p.linea === 'ONYX')
    ? '1n3Yxe74fmUKQga8bGjapBn5UHE0ZQo5_'   // Palas Onyx 2.0
    : '1pcs8zocfVJTVWXXCmJerED8_WFM8SXjs';  // Palas 2026
  const sub = cat.subcarpetas.find(s => s.url.endsWith(folderId));
...
const PALAS = [
  ...
  },
  {
    ...
    forma:"Diamante", peso:"365-375 g", perfil:"38 mm",
    balance:"Medio", superficie:null,
    exterior:"Fibra de vidrio (decal Carbono 3K)", interior:"BlackEva",
    rugoso:"Top Spin", tacto:"Intermedio",
    tecnologias:["Topspin"],
    materiales:["PG","BE"],
    jugador:"Gaby Reca",
    perfilJugador:"Jugadores adultos que buscan equilibrio entre potencia y control, con acceso a un modelo inspirado en la pala de Gaby Reca a un precio más accesible.",
    descTecnica:"La Vertex Onyx toma la forma diamante y el balance medio de la familia Vertex y los combina con una construcción más accesible: exterior de fibra de vidrio con decal de carbono 3K y núcleo BlackEva, en un perfil de 38 mm.",
    sensacionJuego:"Golpe equilibrado, sin exigir demasiado del brazo. Responde bien tanto en el fondo de pista como en la red, con una sensación consistente gracias al núcleo BlackEva.",
    argumentoVenta:"La Vertex, pero accesible: la estética y la forma de la pala insignia de Bullpadel, inspirada en el modelo de Gaby Reca, en la línea Onyx pensada para el mercado argentino.",
    relacionados:["onyxcomfort","onyxpower","ioniccontrol26"],
    nota:null,
    tipo_pala:"standard"
  },
  {
    ...
    forma:"Diamante", peso:"355-365 g", perfil:"38 mm",
    balance:"Alto", superficie:null,
    exterior:"Fibra de vidrio", interior:"BlackEva",
    rugoso:"Top Spin", tacto:"Intermedio",
    tecnologias:["Topspin"],
    materiales:["PG","BE"],
    jugador:"Julieta Bidahorria",
    perfilJugador:"Jugadoras que buscan potencia con balance alto y un plus de tecnología, con el respaldo de Julieta Bidahorria en la línea Onyx.",
    descTecnica:"La Vertex Onyx W combina forma diamante y balance alto para maximizar la potencia sin resignar control. Exterior de fibra de vidrio y núcleo BlackEva, en perfil de 38 mm.",
    sensacionJuego:"Pala pensada para pegar fuerte sin perder margen: el balance alto ayuda a definir puntos, mientras el núcleo BlackEva mantiene la salida de bola consistente golpe a golpe.",
    argumentoVenta:"Potencia y tecnología con el respaldo de Julieta Bidahorria, en la versión Onyx más accesible de la familia Vertex.",
    relacionados:["onyxcomfortw","onyxpowerw","ioniclight26"],
    nota:null,
    tipo_pala:"w"
  },
  {
    ...
    forma:"Diamante", peso:"360-370 g", perfil:"38 mm",
    balance:"Alto", superficie:null,
    exterior:"Fibra de vidrio (decal Carbono 3K)", interior:"SoftEva",
    rugoso:null, tacto:"Blando",
    tecnologias:[],
    materiales:["PG","SE"],
    jugador:null,
    perfilJugador:"Jugadores de nivel intermedio, aptos desde los 12 años, que buscan una pala de ataque con buena salida de bola sin resignar comodidad en el brazo.",
    descTecnica:"La Onyx Power apuesta por la potencia con un exterior de fibra de vidrio con decal de carbono 3K y núcleo SoftEva, en un perfil de 38 mm que da versatilidad al golpeo.",
    sensacionJuego:"El núcleo SoftEva aporta buena amortiguación y reactividad, facilitando el control en el ataque sin una respuesta demasiado exigente para un jugador que recién está subiendo de nivel.",
    argumentoVenta:"Potencia accesible: para el jugador que quiere empezar a pegar más fuerte sin saltar directo a una pala de gama alta.",
    relacionados:["onyxcomfort","vertexonyx","onyxcontrol"],
    nota:null,
    tipo_pala:"standard"
  },
  {
    ...
    forma:"Diamante", peso:"355-365 g", perfil:"38 mm",
    balance:"Alto", superficie:null,
    exterior:"Fibra de vidrio", interior:"SoftEva",
    rugoso:null, tacto:"Blando",
    tecnologias:[],
    materiales:["PG","SE"],
    jugador:null,
    perfilJugador:"Jugadoras de nivel intermedio que buscan una pala de ataque, con un peso más liviano que la versión estándar para facilitar la velocidad de mano.",
    descTecnica:"La Onyx Power W combina núcleo SoftEva y exterior de fibra de vidrio en un formato más liviano, con perfil de 38 mm y superficie lisa que suma efecto al golpe.",
    sensacionJuego:"Pala liviana y de fácil manejo, pensada para jugadoras que priorizan la potencia sin perder maniobrabilidad en la red.",
    argumentoVenta:"La versión femenina de la Onyx Power: potencia y buena salida de bola en un formato pensado para jugadoras.",
    relacionados:["onyxcomfortw","vertexonyxw","onyxcontrolw"],
    nota:null,
    tipo_pala:"w"
  },
  {
    ...
    materiales:["PG","SE"],
    jugador:null,
    perfilJugador:"Jugadores que están dando sus primeros pasos y priorizan el control y la manejabilidad por sobre la potencia.",
    descTecnica:"La Onyx Control tiene forma redonda y balance bajo para maximizar la manejabilidad. Exterior Polyglass e interior SoftEva, con marco CarbonTube 100% carbono para dar resistencia sin perder ligereza.",
    sensacionJuego:"Pala liviana y muy manejable. El balance bajo facilita el control en cada golpe, ideal para quien todavía está construyendo su técnica.",
    argumentoVenta:"La puerta de entrada a Bullpadel: control y comodidad al mejor precio de la línea Onyx.",
    relacionados:["onyxpower","onyxcomfort","ioniccontrol26"],
    nota:null,
    tipo_pala:"standard"
  },
  {
    ...
    materiales:["PG","SE"],
    jugador:null,
    perfilJugador:"Jugadoras que están empezando y buscan una pala liviana, cómoda y fácil de manejar para ganar seguridad en cada golpe.",
    descTecnica:"La Onyx Control W comparte la forma redonda y el balance bajo de la versión estándar, con exterior Polyglass, interior SoftEva y marco CarbonTube 100% carbono.",
    sensacionJuego:"Estructura ligera y cómoda que prioriza la seguridad del golpeo por sobre la potencia — ideal para dominar el juego de a poco.",
    argumentoVenta:"La entrada de la línea Onyx para jugadoras: control, comodidad y el precio más accesible del catálogo.",
    relacionados:["onyxpowerw","onyxcomfortw","ioniclight26"],
    nota:null,
    tipo_pala:"w"
  },
  {
    ...
    forma:"Diamante", peso:"360-370 g", perfil:"38 mm",
    balance:"Alto", superficie:null,
    exterior:"Glaphite", interior:"BlackEva",
    rugoso:null, tacto:"Intermedio",
    tecnologias:[],
    materiales:["GP","BE"],
    jugador:null,
    perfilJugador:"Jugadores adultos que buscan potencia con una construcción más amable para el brazo, gracias a la fibra Glaphite.",
    descTecnica:"La Onyx Comfort combina forma diamante y balance alto con exterior Glaphite (mezcla de carbono y fibra de vidrio) e interior BlackEva, en perfil de 38 mm.",
    sensacionJuego:"El Glaphite absorbe parte del impacto sin resignar potencia, dando una sensación más cómoda que una pala de carbono puro en sesiones largas.",
    argumentoVenta:"Potencia sin pagar el precio físico del carbono puro: la fibra Glaphite cuida el brazo sin resignar rendimiento.",
    relacionados:["vertexonyx","onyxpower","onyxcontrol"],
    nota:null,
    tipo_pala:"standard"
  },
  {
    ...
    materiales:["GP","BE"],
    jugador:null,
    perfilJugador:"Jugadoras que buscan potencia y una transición cómoda entre defensa y ataque, sin resignar comodidad en el golpeo.",
    descTecnica:"La Onyx Comfort W tiene forma diamante y balance medio, con exterior Glaphite e interior BlackEva. Incorpora un puente vertical con contrapesos metálicos que estabiliza el golpeo.",
    sensacionJuego:"Pala versátil que se adapta bien tanto al fondo de pista como a la red, con una sensación cómoda gracias a la fibra Glaphite.",
    argumentoVenta:"Confort y versatilidad para la jugadora que quiere una pala que la acompañe en cualquier situación de juego.",
    relacionados:["vertexonyxw","onyxpowerw","onyxcontrolw"],
    nota:null,
    tipo_pala:"w"
  }
];
...
const PALAS_COMPETENCIA = [
  {
    ...
    precioPublicoArs:799000, jugadorPro:"Agustín Tapia",
  ...
  },
  {
    ...
    precioPublicoArs:735000, jugadorPro:"Agustín Tapia",
  ...
  },
  {
    ...
    precioPublicoArs:695000, jugadorPro:"Agustín Tapia",
  ...
  },
  {
    ...
    precioPublicoArs:695000, jugadorPro:"Edu Alonso",
  ...
  },
  {
    ...
    precioPublicoArs:690000, jugadorPro:"Miguel Lamperti",
  ...
  },
  {
    ...
    precioPublicoArs:615000, jugadorPro:"Aranzazu Osoro",
    bullpadelEquivalente1:"Neuron 02",
    bullpadelEquivalente2:"Vertex 05 Hybrid",
  ...
  },
  {
    ...
    precioPublicoArs:790000, jugadorPro:"Ale Galán",
    bullpadelEquivalente1:"XPLO 26",
    bullpadelEquivalente2:"Hack 04 26",
    bullpadelEquivalente3:"Vertex 05 Geo",
  ...
  },
  {
    ...
    precioPublicoArs:855000, jugadorPro:"Ale Galán",
    bullpadelEquivalente1:"Neuron 02",
    bullpadelEquivalente2:"Vertex 05 Hybrid",
    bullpadelEquivalente3:"Hack 04 Hybrid 26",
  ...
  },
  {
    ...
    precioPublicoArs:750000, jugadorPro:"Ale Galán",
  ...
  },
  {
    ...
    precioPublicoArs:436050, jugadorPro:null,
  ...
  },
  {
    ...
    precioPublicoArs:598500, jugadorPro:"Maxi Arce",
    bullpadelEquivalente1:"XPLO 26",
  ...
  },
  {
    ...
    precioPublicoArs:390000, jugadorPro:null,
    bullpadelEquivalente1:"Ionic Power 26",
    bullpadelEquivalente2:"Vertex Advance",
    bullpadelEquivalente3:"XPLO Comfort 26",
  ...
  },
  {
    ...
    precioPublicoArs:650000, jugadorPro:"Juan Lebrón",
    bullpadelEquivalente1:"Hack 04 26",
    bullpadelEquivalente2:"XPLO 26",
    bullpadelEquivalente3:"Vertex 05 Geo",
  ...
  },
  {
    ...
    precioPublicoArs:670000, jugadorPro:"Juan Lebrón",
    bullpadelEquivalente1:"XPLO 26",
    bullpadelEquivalente2:"Hack 04 26",
    bullpadelEquivalente3:"Vertex 05 Geo",
  ...
  },
  {
    ...
    precioPublicoArs:550000, jugadorPro:null,
  ...
  },
  {
    ...
    precioPublicoArs:446145, jugadorPro:"Juan Lebrón",
  ...
  },
  {
    ...
    precioPublicoArs:576450, jugadorPro:null,
  ...
  },
  {
    ...
    fuenteOficialUrl:"https://www.babolat.com/us/padel/racquets.html",
    precioPublicoArs:440000, jugadorPro:null,
  ...
  },
  {
    ...
    fuenteOficialUrl:"https://www.babolat.com/us/padel/racquets.html",
    precioPublicoArs:532500, jugadorPro:null,
  ...
  },
  {
    ...
    fuenteOficialUrl:"https://www.babolat.com/us/padel/racquets.html",
    precioPublicoArs:339000, jugadorPro:null,
...
const MEDIA_CENTER = {
  ...
  "02 Imagenes de producto": {
    ...
    subcarpetas: [
      { nombre: "01 Palas 2027",             url: "https://drive.google.com/drive/folders/15E98OmwDj0nAcpwaxVNfh6NvxZZeEVBf" },
      { nombre: "02 Palas 2026",             url: "https://drive.google.com/drive/folders/1pcs8zocfVJTVWXXCmJerED8_WFM8SXjs" },
      { nombre: "03 Textil 2026",            url: "https://drive.google.com/drive/folders/1d8s-x7Iy7GF9epGES8FH9i5Me5stbhjv" },
      { nombre: "04 Bolsos 2026",            url: "https://drive.google.com/drive/folders/1-TH7zR3j6JJyUCex1NvAVJ52a_9HFVKp" },
      { nombre: "05 Calzado 2026",           url: "https://drive.google.com/drive/folders/1zdQe4Mm3DA66Ghock-1cmXG_MBVvxBMB" },
      { nombre: "06 Palas ARG 2026",         url: "https://drive.google.com/drive/folders/1CI1mPYSn-tiBheT_47c0QFQjsLxcL4qW" },
      { nombre: "07 Palas Onyx 2.0",         url: "https://drive.google.com/drive/folders/1n3Yxe74fmUKQga8bGjapBn5UHE0ZQo5_" },
      { nombre: "08 Palas premier 2026",     url: "https://drive.google.com/drive/folders/1Z8hrXrT8m9-_vF6Vp3j1ofgmgkBsCo_z" },
      { nombre: "09 Palas Apache 32",        url: "https://drive.google.com/drive/folders/1nWMXK-vnXMMRej2CQgr6EgWb9G0yJ4L4" },
      { nombre: "10 Línea APA",              url: "https://drive.google.com/drive/folders/1UgHGmPUfGSRwCni4_tSuGVe-IhB8hGLs" },
      { nombre: "11 Pack Vertex 25",         url: "https://drive.google.com/drive/folders/1tJwWtYWGKzdLjKK54yByQLesGm0Ox8-g" },
      { nombre: "12 Remeras de jugadores",   url: "https://drive.google.com/drive/folders/1Ss_UjtwoLPSX2OXWZYJYAxE7MlUyoQKi" },
      { nombre: "13 Accesorios Atemporales", url: "https://drive.google.com/drive/folders/1s2doYjwqgmRiE16GAwLDer0nWX20ozfT" },
      { nombre: "14 Complementarios",        url: "https://drive.google.com/drive/folders/14xpDzCi1CWJZDDzrkR2hizPgg7Qx0Oma" }
    ]
  },
